...
insert into cardinals values ('IDV_CTO1','IDV_CTO2','IDV_CTO2',NULL,NULL,'IDV_GRNDCNT1',NULL,NULL,NULL);
insert into cardinals values ('IDV_CTO2',NULL,'IDV_CTO3','IDV_CTO3',NULL,'IDV_CTO1','IDV_CTO1',NULL,NULL);
insert into cardinals values ('IDV_CTO3','IDV_MANPAN',NULL,'IDV_ctya',NULL,NULL,NULL,'IDV_CTO2',NULL);
insert into cardinals values ('IDV_LOCKERR','IDV_LOCKERN',NULL,'IDV_ctyg',NULL,'IDV_LOCKERS',NULL,'IDV_LOCKERW',NULL);
insert into cardinals values ('IDV_ctya','IDV_ctyb','IDV_ctye','IDV_ctyd',NULL,'IDV_ctyc',NULL,'IDV_CTO3',NULL);
insert into cardinals values ('IDV_ctyb','IDV_ctyhouse',NULL,'IDV_ctye','IDV_ctyd','IDV_ctya',NULL,NULL,NULL);
insert into cardinals values ('IDV_ctyc','IDV_ctya','IDV_ctyd',NULL,NULL,'IDV_ctysmith',NULL,NULL,NULL);
insert into cardinals values ('IDV_ctyd','IDV_ctye',NULL,'IDV_ctyn',NULL,'IDV_ctyk','IDV_ctyc','IDV_ctya','IDV_ctyb');
insert into cardinals values ('IDV_ctye',NULL,'IDV_ctyg','IDV_ctyf',NULL,'IDV_ctyd',NULL,'IDV_ctyb',NULL);
insert into cardinals values ('IDV_ctyf','IDV_ctyg',NULL,'IDV_ctyh',NULL,NULL,NULL,'IDV_ctye',NULL);
insert into cardinals values ('IDV_ctyg','IDV_LOCKERR',NULL,NULL,NULL,'IDV_ctyf','IDV_ctye',NULL,NULL);
insert into cardinals values ('IDV_ctyh',NULL,'IDV_ctyj','IDV_ctyi',NULL,NULL,NULL,'IDV_ctyf',NULL);
insert into cardinals values ('IDV_ctyi','IDV_ctyj',NULL,NULL,NULL,'IDV_ctyp',NULL,'IDV_ctyh',NULL);
insert into cardinals values ('IDV_ctyj',NULL,NULL,NULL,NULL,'IDV_ctyi',NULL,'IDV_CTLIB1A','IDV_CTLIB1A');
insert into cardinals values ('IDV_ctyk','IDV_ctyd',NULL,'IDV_ctyl','IDV_ctys',NULL,NULL,'IDV_ctys','IDV_ctya');
insert into cardinals values ('IDV_ctyl','IDV_ctyn',NULL,'IDV_ctyo','IDV_ctym','IDV_ctys',NULL,'IDV_ctyk',NULL);
insert into cardinals values ('IDV_ctym','IDV_ctyl','IDV_ctyq','IDV_ctyr',NULL,'IDV_ctyt',NULL,'IDV_ctys','IDV_ctyk');
insert into cardinals values ('IDV_ctyn',NULL,NULL,NULL,NULL,NULL,NULL,'IDV_ctyd',NULL);
insert into cardinals values ('IDV_ctyo',NULL,NULL,'IDV_ctyq','IDV_ctyr','IDV_ctym','IDV_ctys','IDV_ctyl',NULL);
insert into cardinals values ('IDV_ctyp','IDV_ctyi',NULL,NULL,NULL,'IDV_ctyq',NULL,NULL,NULL);
insert into cardinals values ('IDV_ctyq','IDV_ctyp',NULL,NULL,NULL,'IDV_ctyr','IDV_ctym','IDV_ctyo',NULL);
insert into cardinals values ('IDV_ctyr','IDV_ctyq',NULL,'IDV_ctytrade',NULL,'IDV_ctyt','IDV_ctym','IDV_ctyl','IDV_ctyo');
insert into cardinals values ('IDV_ctys','IDV_ctyl','IDV_ctyo','IDV_ctym','IDV_ctyt',NULL,NULL,'IDV_ctychem','IDV_ctyk');
insert into cardinals values ('IDV_ctyt','IDV_ctym','IDV_ctyr',NULL,NULL,NULL,NULL,NULL,'IDV_ctys');
insert into cardinals values ('IDV_CTLIB1A',NULL,'IDV_ctyj',NULL,NULL,NULL,'IDV_CTLIB1B',NULL,NULL);
insert into cardinals values ('IDV_CTLIB1B','IDV_CARDMACH1','IDV_CTLIB1A','IDV_CARDMACH6','IDV_CARDMACH5','IDV_CARDMACH4','IDV_CARDMACH3','IDV_ctychem','IDV_CARDMACH2');
...
insert into cardinals values ('IDV_VIL4',NULL,NULL,'IDV_GRUB0000','IDV_DICE0000','IDV_VIL3','IDV_WOOD0000',NULL,'IDV_VILDOOR');
...
insert into cardinals values ('IDV_QUARSA','IDV_QUARSB','IDV_QUARSB',NULL,NULL,'IDV_GRNDCNT1',NULL,NULL,'IDV_QUARSB');
...
insert into cardinals values ('IDV_N2A',NULL,NULL,'IDV_N2B',NULL,NULL,NULL,'IDV_ORIE',NULL);
...
insert into cardinals values ('IDV_NAT1c',NULL,'IDV_NAT1d',NULL,NULL,'IDV_NAT1b',NULL,NULL,NULL);
