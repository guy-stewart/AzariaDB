...
insert into triggers values ('IDV_CONTINENT',1218,204,1380,336,'IDV_CTO1', 360);
...
insert into triggers values ('IDV_ORIE',763,83,833,147,'IDV_GUITECHPAN', 0);
...
insert into triggers values ('IDV_TM1PAN',1454,50,1600,300,'IDV_TMPLPTH5', 178);
insert into triggers values ('IDV_TM1PAN',2028,160,2459,300,'IDV_VESTPAN1', -1);
insert into triggers values ('IDV_MOON4',2341,165,2440,220,'IDV_CU_GRASSPATCH1', 278);
