...
('M12_xCANDLE','20','21','SIGNAL','WIP3','SIG_CHECK','REF_MACHINE(WIP3);',''),
('M12_xCANDLE','21','22','GTi','R_WPARM','0','',''),
('M12_xCANDLE','21','0','Z_EPSILON','','','',''),
('M12_xCANDLE','22','0','EQUAL','R_WPARM','R_BPARM','SIGNAL(WIP1,SIG_SHOW);ASSIGN(BPARM,0);',''),
...
('M12_xCANDLELIGHT','1','2','SIGNAL','WIP4','SIG_SHOW','',''),
...
('M12_xPLANT','0','5','WAIT','','SIG_SHOW','REF_MACHINE(WIP1);MOV(BFRAME,R_WPARM);MAP(BFRAME,WIP2);',''),
('M12_xPLANT','0','20','WAIT','','SIG_HIDE','',''),
('M12_xPLANT','0','30','WAIT','','SIG_CLOSE','',''),
...
('M12_xPLANT','5','6','GT','BFRAME','0','ASSIGN(WPARM,1);',''),
('M12_xPLANT','5','0','Z_EPSILON','','','ASSIGN(WPARM,0)',''),
('M12_xPLANT','6','7','SHOW','WIP3','','',''),
('M12_xPLANT','7','0','Z_EPSILON','','','
        MOV(WOBJECT,BFRAME);
        MAPi(WOBJECT,S12_NATURE_REP);
        C_ACCEPT(WOBJECT);',''),
('M12_xPLANT','9','0','SHOW','WOBJECT','0','ASSIGN(BPARM,1);',''),
('M12_xSCROLL','0','5','cangrab','0','IDC_SCROLL','',''),
('M12_xSCROLL','10','11','MOV','WPARM','WOBJECT','MAPi(WPARM,S12_SCROLL);',''),
('M12_xSCROLL','11','12','MOV','WTEMP1','WPARM','MAPi(WTEMP1,S12_ING_LOC);',''),
('M12_xSCROLL','12','0','NEQUAL','WTEMP1','WIP1','PLAYWAVE(SOUND_HURT);',''),
('M12_xSCROLL','12','13','Z_EPSILON','','','',''),
('M12_xSCROLL','13','5','SHOW','','IDS_SCRHUNG','SIGNAL(WIP2,SIG_SHOW);',''),
('M12_xSCROLL','21','22','SIGNAL','WIP2','SIG_CHECK','REF_MACHINE(WIP2);',''),
('M12_xSCROLL','22','30','EQUAL','R_WPARM','0','',''),
('M12_xSCROLL','22','23','Z_EPSILON','','','',''),
('M12_xSCROLL','23','5','SHOW','0','0','',''),
('M12_xSCROLL','30','5','SHOW','0','0','SIGNAL(WIP2,SIG_HIDE);SIGNAL(WIP3,SIG_HIDE); SIGNAL(WIP4,SIG_HIDE);',''),
