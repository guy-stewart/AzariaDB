...
('M12_xPLANT','7','0','Z_EPSILON','','','
        ...
        C_ACCEPT(WOBJECT);',''),
('M12_xPLANT','9','0','SHOW','WOBJECT','0','ASSIGN(BPARM,1); SIGNAL(WIP4,SIG_CHECK);',''),
...
('M12_xSCROLL','13','0','SHOW','','IDS_SCRHUNG','SIGNAL(WIP2,SIG_SHOW);',''),
('M12_xSCROLL','30','0','SHOW','0','0','SIGNAL(WIP2,SIG_HIDE);SIGNAL(WIP3,SIG_HIDE); SIGNAL(WIP4,SIG_HIDE);',''),
