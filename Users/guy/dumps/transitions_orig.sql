...
('M12_xASHSHELF','0','4','WAIT','','SIG_SHOW','REF_MACHINE(WIP1);MOV(WOBJECT,R_WPARM);MAP(WOBJECT,WIP2);,''),
...
('M12_xSCROLL','12','15','NEQUALi','WTEMP1','1',',''),
('M12_xSCROLL','12','20','Z_EPSILON','','','
        SIGNAL(WIP2,SIG_SHOW);  
,''),
('M12_xSCROLL','15','0','GRAB','0','','SHOW();,''),
('M12_xSCROLL','20','21','GRAB','0','','SHOW();,''),
('M12_xSCROLL','21','0','SIGNAL','WIP2','SIG_HIDE','SIGNAL(WIP3,SIG_HIDE); SIGNAL(WIP4,SIG_HIDE);,''),
